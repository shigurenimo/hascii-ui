...
const help = `usage: hascii-ui components file-tree [options]
...
export const fileTreeHandler = factory.createHandlers(
  customValidator("query", schema, help),
  async (c) => {
    const query = c.req.valid("query")

    await renderComponent(
      <HasciiFileTree nodes={NODES} defaultExpanded={["Main", "Text"]} indent={query.indent} />,
    )
